...
{
    addMark(x, y,xpos, ypos, juce::Colours::red);
}

/** Adds visible mark at  coordinates xpos, ypos, specify colour */
void addMark(Plotdata& x, Plotdata& y, double xpos, double ypos, juce::Colour colour)
{
    setColor(x, y, colour);
...
void setColor(Plotdata& x, Plotdata& y, juce::Colour colour)
{
