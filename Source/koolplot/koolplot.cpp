...
{
    addMark(x, y,xpos, ypos, Colours::red);
}
...
{
    Plotdata::colorChange(x, y, colour.getARGB());
}
 ...
 */
Image plot( const Plotdata & x, const Plotdata & y)
{
	Plotstream ps;
 ...
 */
Image plot( const Plotdata & x, const Plotdata & y, Colour colour)
{
	Plotstream ps;
 ...
 */
Image plot(const Plotdata & x, Func & aFunction)
{
	Plotstream ps;
 ...
 */
Image plot(const Plotdata & x, Func & aFunction, Colour colour)
{
    Plotstream ps;
